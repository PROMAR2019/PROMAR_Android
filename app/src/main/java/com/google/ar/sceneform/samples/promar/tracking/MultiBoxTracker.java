...
package com.google.ar.sceneform.samples.promar.tracking;
...
import com.google.ar.sceneform.samples.promar.env.Logger;
...
public class MultiBoxTracker {
  private  final String TAG = "RECTANGLE_DEBUG";
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    //TODO: the map matrix has problem: the destination of object is not a fix ratio
...
//            (int) (multiplier * (rotated ? frameWidth : frameHeight)),
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      Log.d(TAG, "tracker: rect before transform " + trackedPos.toString());
      getFrameToCanvasMatrix().mapRect(trackedPos);
      Log.d(TAG, "tracker: rect after transform " + trackedPos.toString());
